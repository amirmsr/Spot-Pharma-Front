...
function EditIntervenant2() {
    ...
    const uploadVideo = useMutation((formData: FormData) => {
        return fetch(`https://spot-pharma-api-bd00f8c1ff03.herokuapp.com/sessions/intervenant2/${sessionId}`, {
            method: 'PUT',
            body: formData
        }).then((response) => {
    ...
    const handleSubmit = async (e:React.FormEvent<HTMLFormElement>)=>{
        ...
        if (selectedFile) {
            formData.append("intervenant2", selectedFile);
        }
    ...
    return (
        <div>
            <Form onSubmit={handleSubmit} className="mb-3" style={{paddingBottom:'300px',paddingTop:'100px'}}>
                <Form.Label>Changer image intervenant 2</Form.Label>
